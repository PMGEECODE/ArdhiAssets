# fastapi-server/app/models/portable_item.py
...
class PortableItem(Base):
    __tablename__ = "portable_items"
    ...
    def __repr__(self):
        return (
            f"<PortableItem(id={self.id}, asset_description='{self.asset_description[:30]}', "
