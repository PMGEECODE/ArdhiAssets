...
# Base Schema
# ============================================================
class PlantMachineryTransferBase(BaseModel):
    """
    Shared fields for Plant Machinery Transfer.
    """
...
# Create Schema
# ============================================================
class PlantMachineryTransferCreate(PlantMachineryTransferBase):
    """
    Schema for creating a new Plant Machinery Transfer record.
    """
    pass
...
# Response Schema
# ============================================================
class PlantMachineryTransferResponse(PlantMachineryTransferBase):
    """
    Schema returned in API responses.
    """
    
    id: UUID
    plant_machinery_id: UUID
