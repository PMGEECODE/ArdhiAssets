# fastapi-server/app/schemas/plant_machinery.py
...
# Base Schema
# ============================================================
class PlantMachineryBase(BaseModel):
    """
    Base schema for Plant & Machinery
    """

    # Basic information
    asset_description: str = Field(..., description="Description of the plant or machinery")
    financed_by: str = Field(..., description="Financed by")
    serial_number: str = Field(..., description="Serial number of the plant/machinery")
    tag_number: str = Field(..., description="Tag number of the plant/machinery")
    make_model: str = Field(..., description="Make and model of the plant/machinery")
    pv_number: Optional[str] = Field(None, description="PV number")

    # Locations
    original_location: Optional[str] = Field(None, description="Original location of the plant/machinery")
    current_location: Optional[str] = Field(None, description="Current location of the plant/machinery")
    responsible_officer: Optional[str] = Field(None, description="Responsible officer for the plant/machinery")
    ...
    purchase_amount: Decimal = Field(..., description="Purchase amount of the plant/machinery")
    ...
    # Other details
    asset_condition: Optional[str] = Field(None, description="Condition of the plant/machinery (e.g., Good, Poor)")
...
# Create Schema
# ============================================================
class PlantMachineryCreate(PlantMachineryBase):
    """Schema for creating a new Plant & Machinery record"""
    pass
...
# Update Schema
# ============================================================
class PlantMachineryUpdate(BaseModel):
    """Schema for updating a Plant & Machinery record"""
...
# ============================================================
class PlantMachineryInDBBase(PlantMachineryBase):
    """
...
# Response Schema
# ============================================================
class PlantMachinery(PlantMachineryInDBBase):
...
# Internal DB Schema
# ============================================================
class PlantMachineryInDB(PlantMachineryInDBBase):
